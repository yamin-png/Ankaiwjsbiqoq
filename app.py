...
# Define the Chrome binary path for cloud environments
CHROME_BINARY_PATH = "/usr/bin/chromium-browser"  # Path to Chromium in cloud environments
...
def process_login(email, password):
    ...
    # Use the Chrome binary path installed in the cloud environment
    chrome_options.add_argument(f"--binary={CHROME_BINARY_PATH}")
    chrome_options.add_argument("--headless")  # Run headlessly (without opening the browser window)
